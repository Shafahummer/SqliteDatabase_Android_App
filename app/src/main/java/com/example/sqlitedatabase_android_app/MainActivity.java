package com.example.sqlitedatabase_android_app;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button buttonAdd,buttonGetData,buttonDelete,buttonViewAll,buttonUpdate;
    @Override
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isUpdate==true){
                    ...
                    Toast.makeText(MainActivity.this,"Ooopss!!Something wrong!",Toast.LENGTH_SHORT).show();
            }
        });
    }
